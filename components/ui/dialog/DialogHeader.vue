...
const showClose = ref(props.showClose || true);
...
<template>
  <div
    :class="cn('flex justify-between  gap-y-1.5 text-center sm:text-left', props.class)"
  >
    <slot />
   
    <DialogClose v-show="showClose"
