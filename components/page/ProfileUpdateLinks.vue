        ...
        <form class="flex gap-4 flex-col px-2 lg:px-0 w-full lg:w-2/6 ">
            ...
            <FormItem class="space-y-1">
              ...
              <FormControl>
                <div class="flex items-center border border-secondary-body-500 rounded-md relative">
                  <span class="bg-[#F2F4F7] pl-8 text-[#98A2B3] rounded-l-md px-3 h-11 py-2 text-sm border border-gray-300 border-r-0 flex items-center whitespace-nowrap">
                    https://
                  </span>
                  <Input type="text"
                    class="h-11 border-0 ring-[#D0D5DD] focus:bg-[#F5F5F5] ring-0 rounded-[8px] focus-visible:ring-0 focus-visible:ring-offset-0 border-[#D0D5DD] text-[#3F434A] placeholder:text-gray-400 text-sm"
          ...
          <FormField :modelValue="links?.results?.find(type => type.platform == 'LINKEDIN')?.url" v-slot="{ componentField }" name="linkedIn">
            ...
            <div class="flex items-center border border-secondary-body-500 rounded-md relative">
              ...
              <Input type="text"
                  class="h-11 border-0 ring-[#D0D5DD] ring-0  rounded-[8px] focus-visible:ring-0 focus-visible:ring-offset-0 border-[#D0D5DD] text-[#3F434A] placeholder:text-gray-400 text-sm"
...
<script setup>
import { CheckIcon, LoaderCircle, Mail, Globe } from 'lucide-vue-next';
