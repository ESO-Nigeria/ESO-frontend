...
<template>
  <div>
    <div class="bg-white border-t">
      <div
      class="flex flex-col lg:flex-row lg:justify-between gap-3 lg:items-center px-6 py-[19px] border-b-[1.5px] border-gray-200">
      <div class="flex flex-col lg:flex-row lg:items-center space-y-2 lg:space-x-2">
        <div
