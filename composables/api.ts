...
export const apiGetRequest = async (url: string): Promise<ApiResponse> => {
  ...
  try {
    ...
    return { data: null, error: error?.response?.data ?? 'Network error: Unable to reach the server. Please check your internet connection.' };
  }
};
...
export const apiPutRequest = async (url: string, body: object): Promise<ApiResponse> => {
  ...
  try {
    ...
    const response = await axios.put(baseURL + url, body, { headers });
    return { data: response.data, error: null };
  } catch (error: any) {
    return { data: null, error: error?.response?.data ?? 'Network error: Unable to reach the server. Please check your internet connection.' };
  }
...
export const apiPatchRequest = async (url: string, body: object): Promise<ApiResponse> => {
  ...
  try {
    ...
    const response = await axios.patch(baseURL + url, body, { headers });
    return { data: response.data, error: null };
  } catch (error: any) {
    return { data: null, error: error?.response?.data ?? 'Network error: Unable to reach the server. Please check your internet connection.' };
  }
